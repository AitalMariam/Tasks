...
<div class="container">
    <div class="btn_container">
        <div  class="col-12 text-center">
            ...
            <a href="EditCheckList.php"><button class="btn btn-outline-light btn-lg"><i class="fas fa-edit"></i>&nbsp; Edit List</button></a>
            <a href=""><button class="btn btn-outline-light btn-lg" type="button" data-toggle="modal" data-target="#OrderModal"><i class="fas fa-sort"></i>&nbsp; Order Lists</button></a>
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="Submissions_checklist.php">View by List</a>
            </div>
        </div>
    </div>
</div>
